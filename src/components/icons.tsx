interface IconProps {
  /** Tailwind size + color classes, e.g. "w-4 h-4 text-gray-500". */
  className?: string;
}

// Canonical glyph icons — single source of truth for every icon used in more than
// one place. Same meaning => same drawing; don't re-inline these paths at point
// of use. Single-use decorative illustrations stay inline in their page.
...
export function MinusCircleIcon({ className = "w-4 h-4" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
  ...
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}
        d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z" />
    </svg>
  );
}
