...
- **`repo::apply_backend_env` filters reserved (`PATH`/`RESTIC_*`) credential keys itself,
  ...
  valuable as the earlier, loud rejection a user actually sees.
